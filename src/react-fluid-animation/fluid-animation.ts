...
export default class FluidAnimation {
    ...
    _splatStack: any;
    _gl: any;
    _ext: { formatRGBA: any; formatRG: any; formatR: any; halfFloatTexType: any; supportLinearFiltering: any; };
    _time: number;
    _timer: number;
    _width: any;
    _height: any;
    ...
    _blit = (destination: any) => {
        const gl = this._gl
        gl.bindFramebuffer(gl.FRAMEBUFFER, destination)
        gl.drawElements(gl.TRIANGLES, 6, gl.UNSIGNED_SHORT, 0)
    }

    _splat(x: any, y: any, dx: any, dy: any, color: any) {
        const gl = this._gl
